...
import 'push_settings_page_model.dart';
export 'push_settings_page_model.dart';

class PushSettingsPageWidget extends StatefulWidget {
  const PushSettingsPageWidget({super.key});

  @override
  State<PushSettingsPageWidget> createState() => _PushSettingsPageWidgetState();
}

class _PushSettingsPageWidgetState extends State<PushSettingsPageWidget> {
  late PushSettingsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PushSettingsPageModel());
  }
